...
class TrainingEntity
  ...
  def make
    opts = @_entopts.dup
    TrainingEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [TrainingListMatch, Hash, nil] match filter (any subset of
  #   Training fields); defaults to nil, treated as an empty match that lists all.
