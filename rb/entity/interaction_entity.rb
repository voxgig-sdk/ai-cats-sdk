...
class InteractionEntity
  ...
  def make
    opts = @_entopts.dup
    InteractionEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [InteractionListMatch, Hash, nil] match filter (any subset of
  #   Interaction fields); defaults to nil, treated as an empty match that lists all.
