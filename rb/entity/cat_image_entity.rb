...
class CatImageEntity
  ...
  def make
    opts = @_entopts.dup
    CatImageEntity.new(@_client, opts)
  end
  ...
  # @return [CatImage, Hash] the current CatImage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CatImage fields)
  def match_get
  ...
  #
  # @param reqmatch [CatImageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.CatImage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [CatImage, Hash] the loaded CatImage; raises AiCatsError on failure
