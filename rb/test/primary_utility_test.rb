...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = AiCatsOmni.make_runner(TEST_JSON_FILE, AiCatsSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : AiCatsOmni.errify(err)
    end
