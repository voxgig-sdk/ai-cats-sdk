...
module AiCatsTestRunner
  ...
  def self.env_override(m)
    live = getenv("AICATS_TEST_LIVE")
    override = getenv("AICATS_TEST_OVERRIDE")
    ...
    explain = getenv("AICATS_TEST_EXPLAIN")
    m["AICATS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
