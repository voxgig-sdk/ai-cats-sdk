...
func registerSDKWords(r *eng.Registry, client *sdk.AiCatsSDK) {
...
func runOp(client *sdk.AiCatsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
