...
class AiCatsRatelimitFeature extends AiCatsBaseFeature
{
    ...
    private function _acquire(AiCatsContext $ctx): void
    {
    ...
    private function _track(AiCatsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
