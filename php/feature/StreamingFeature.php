...
class AiCatsStreamingFeature extends AiCatsBaseFeature
{
    ...
    private function _iterate(AiCatsResult $result): \Generator
    {
    ...
    private function _streamable(AiCatsContext $ctx): bool
    {
