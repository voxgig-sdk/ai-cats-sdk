...
class AiCatsCacheFeature extends AiCatsBaseFeature
{
    ...
    private function _through(AiCatsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
