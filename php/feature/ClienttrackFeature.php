...
// AiCats SDK clienttrack feature
...
class AiCatsClienttrackFeature extends AiCatsBaseFeature
{
    ...
    public function PostConstruct(AiCatsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AiCats-SDK';
