...
class AiCatsTimeoutFeature extends AiCatsBaseFeature
{
    ...
    private function _with_timeout(AiCatsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AiCatsContext $_ctx, float $ms): void
    {
        $client = $this->client;
