...
// AiCats SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AiCatsSDK::test)
...
{
    private const SDK_CLASS = 'AiCatsSDK';
    ...
    private const SDK_BASE = 'aicats_sdk';
