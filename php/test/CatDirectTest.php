...
class CatDirectTest extends TestCase
{
    public function test_direct_load_cat(): void
    {
        $setup = cat_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-cat", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
