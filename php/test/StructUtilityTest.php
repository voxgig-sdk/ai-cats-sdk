...
// AiCats SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AiCatsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AiCatsOmni::structfix($now, Struct::undef()))
                        !== json_encode(AiCatsOmni::structfix($val, Struct::undef()))) {
