...
class TrainingDirectTest extends TestCase
{
    public function test_direct_list_training(): void
    {
        $setup = training_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-training", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
