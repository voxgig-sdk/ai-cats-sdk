...
class TrainingEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set AICATS_TEST_TRAINING_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function training_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("AICATS_TEST_TRAINING_ENTID");
