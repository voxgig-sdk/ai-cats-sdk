...
// AiCats SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AiCatsMakeRequest
{
    public static function call(AiCatsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AiCatsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AiCatsResponse($fetched);
        } else {
