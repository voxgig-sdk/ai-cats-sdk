...
The PHP SDK for the AiCats API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Cat(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->AiCats(null)->load(
    ["id" => "test01"], null
);
