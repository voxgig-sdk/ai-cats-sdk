...
class CatEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CatEntity($this->_client, $opts);
    }

    /**
     * @param Cat|array $args Cat data (assoc-array) to store.
     */
    ...
    /**
     * @return Cat|array The current Cat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cat fields).
     */
     ...
     * Load a single Cat.
     *
     * @param CatLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CatLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cat|array The loaded Cat as an assoc-array at the
