...
class HealthEntity
{
     ...
     * Create a new Health.
     *
     * @param HealthCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HealthCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Health|array The created Health as an assoc-array at the
     *   SDK boundary; throws AiCatsError on failure (item-5 convention).
     */
