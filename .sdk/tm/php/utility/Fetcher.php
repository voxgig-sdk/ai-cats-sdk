...
class AiCatsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AiCatsSDK/1.0)';
    ...
    public static function call(AiCatsContext $ctx, string $fullurl, array $fetchdef): array
    {
