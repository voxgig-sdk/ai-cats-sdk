...
class AiCatsProxyFeature extends AiCatsBaseFeature
{
    ...
    public function init(AiCatsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AiCatsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
