...
// AiCats SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AiCatsTestFeature extends AiCatsBaseFeature
{
    ...
    public function init(AiCatsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AiCatsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AiCatsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AiCatsContext $ctx, $op, $args): array
    {
