...
class AiCatsNetsimFeature extends AiCatsBaseFeature
{
    ...
    private function _simulate(AiCatsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AiCatsContext $ctx, array $applied): void
    {
        $client = $this->client;
