...
class AiCatsRbacFeature extends AiCatsBaseFeature
{
    ...
    private function _required(AiCatsContext $ctx): ?string
    {
    ...
    private function _reject(AiCatsContext $ctx, string $required): void
    {
    ...
    private function _track(AiCatsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
