...
class AiCatsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AiCatsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AiCatsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AiCatsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
