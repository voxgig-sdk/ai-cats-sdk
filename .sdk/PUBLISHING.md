...
|---|---|---|
| `ts/` | @voxgig-sdk/ai-cats-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ai-cats-sdk \
      --repository voxgig-sdk/ai-cats-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ai-cats-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ai-cats-sdk --id=<id>` removes it.
