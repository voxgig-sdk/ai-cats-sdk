...
class AiCatsSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('AiCatsSDK: graphql: ' +
  ...
  Cat(entopts?: Record<string, any>) {
    const self = this
    return new CatEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  CatImage(entopts?: Record<string, any>) {
    const self = this
    return new CatImageEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Training(entopts?: Record<string, any>) {
    const self = this
    return new TrainingEntity(self, entopts)
  }
