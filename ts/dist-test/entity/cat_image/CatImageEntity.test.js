...
(0, node_test_1.describe)('CatImageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'cat_image.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set AI_CATS_TEST_CAT_IMAGE_ENTID JSON to run live');
            return;
        }
        ...
        let cat_image_ref01_data = Object.values(setup.data.existing.cat_image)[0];
        // LOAD
        const cat_image_ref01_ent = client.CatImage();
        const cat_image_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(cat_image_ref01_data_dt0.id === cat_image_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/cat_image/CatImageTestData.json');
    ...
    let idmap = transform(['cat_image01', 'cat_image02', 'cat_image03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['AI_CATS_TEST_CAT_IMAGE_ENTID'];
...
//# sourceMappingURL=CatImageEntity.test.js.map