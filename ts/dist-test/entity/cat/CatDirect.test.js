...
(0, node_test_1.describe)('CatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-cat', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-cat', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AI_CATS_TEST_CAT_ENTID'];
...
//# sourceMappingURL=CatDirect.test.js.map