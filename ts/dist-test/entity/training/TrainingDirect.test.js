...
(0, node_test_1.describe)('TrainingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-training', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-training', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AI_CATS_TEST_TRAINING_ENTID'];
...
//# sourceMappingURL=TrainingDirect.test.js.map