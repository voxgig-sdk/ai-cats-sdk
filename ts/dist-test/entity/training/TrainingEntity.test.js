...
(0, node_test_1.describe)('TrainingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'training.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != training_ref01_data.id);
        // LIST
        const training_ref01_match = {};
        const training_ref01_list = (await training_ref01_ent.list(training_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(training_ref01_list, { id: training_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/training/TrainingTestData.json');
    ...
    let idmap = transform(['training01', 'training02', 'training03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=TrainingEntity.test.js.map