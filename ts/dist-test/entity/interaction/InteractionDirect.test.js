...
(0, node_test_1.describe)('InteractionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-interaction', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-interaction', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.AI_CATS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AiCatsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['AI_CATS_TEST_INTERACTION_ENTID'];
    ...
    const client = new __1.AiCatsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=InteractionDirect.test.js.map