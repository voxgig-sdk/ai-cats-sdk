...
function envOverride(m) {
    if ('TRUE' === process.env.AI_CATS_TEST_LIVE ||
        'TRUE' === process.env.AI_CATS_TEST_OVERRIDE) {
    ...
    m.AI_CATS_TEST_EXPLAIN = process.env.AI_CATS_TEST_EXPLAIN || m.AI_CATS_TEST_EXPLAIN;
    return m;
}
