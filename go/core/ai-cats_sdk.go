...
func (sdk *AiCatsSDK) OptionsMap() map[string]any {
...
func (sdk *AiCatsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AiCatsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AiCatsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AiCatsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AiCatsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AiCatsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AiCatsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AiCatsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AiCatsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AiCatsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
