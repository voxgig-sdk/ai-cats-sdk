...
The Golang SDK for the AiCats API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/ai-cats-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/ai-cats-sdk=../path/to/github.com/voxgig-sdk/ai-cats-sdk
```
...
```
github.com/voxgig-sdk/ai-cats-sdk/
...
The root package (`github.com/voxgig-sdk/ai-cats-sdk`) re-exports everything needed
