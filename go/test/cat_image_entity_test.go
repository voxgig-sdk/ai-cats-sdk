...
func TestCatImageEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		catImageRef01DataDt0LoadResult := core.ToMapAny(entityData(catImageRef01DataDt0Loaded))
...
func cat_imageBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("AI_CATS_TEST_CAT_IMAGE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["AI_CATS_TEST_CAT_IMAGE_ENTID"])
