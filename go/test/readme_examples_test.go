...
const testSeed = `map[string]any{"entity": map[string]any{"cat": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cat_image": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "health": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "interaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "training": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
