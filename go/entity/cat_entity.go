...
func NewCatEntity(client *core.AiCatsSDK, entopts map[string]any) *CatEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CatEntity) GetName() string { return e.name }
...
func (e *CatEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CatEntity) Deleted() bool {
	return e.deleted
}


func (e *CatEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCatEntity(e.client, opts)
}

func (e *CatEntity) Data(args ...any) any {
...
func (e *CatEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cat; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CatEntity) DataTyped(data ...Cat) Cat {
	if len(data) > 0 {
		return typedFrom[Cat](e.Data(asMap(data[0])))
	}
	return typedFrom[Cat](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cat (all fields
// optional at the wire level).
func (e *CatEntity) MatchTyped(match ...Cat) Cat {
	if len(match) > 0 {
		return typedFrom[Cat](e.Match(asMap(match[0])))
	}
	return typedFrom[Cat](e.Match())
}
...
func (e *CatEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CatEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CatLoadMatch and returns an Cat. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CatEntity) LoadTyped(reqmatch CatLoadMatch, ctrl map[string]any) (Cat, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Cat{}, err
	}
	return typedFrom[Cat](res), nil
}



func (e *CatEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CatEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CatEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CatEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CatEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
