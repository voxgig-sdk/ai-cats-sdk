...
func NewCatImageEntity(client *core.AiCatsSDK, entopts map[string]any) *CatImageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CatImageEntity) GetName() string { return e.name }
...
func (e *CatImageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CatImageEntity) Deleted() bool {
	return e.deleted
}


func (e *CatImageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCatImageEntity(e.client, opts)
}

func (e *CatImageEntity) Data(args ...any) any {
...
func (e *CatImageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CatImage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CatImageEntity) DataTyped(data ...CatImage) CatImage {
	if len(data) > 0 {
		return typedFrom[CatImage](e.Data(asMap(data[0])))
	}
	return typedFrom[CatImage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CatImage (all fields
// optional at the wire level).
func (e *CatImageEntity) MatchTyped(match ...CatImage) CatImage {
	if len(match) > 0 {
		return typedFrom[CatImage](e.Match(asMap(match[0])))
	}
	return typedFrom[CatImage](e.Match())
}
...
func (e *CatImageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CatImageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CatImageLoadMatch and returns an CatImage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CatImageEntity) LoadTyped(reqmatch CatImageLoadMatch, ctrl map[string]any) (CatImage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CatImage{}, err
	}
	return typedFrom[CatImage](res), nil
}



func (e *CatImageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CatImageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CatImageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CatImageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CatImageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
