...
func NewTrainingEntity(client *core.AiCatsSDK, entopts map[string]any) *TrainingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TrainingEntity) GetName() string { return e.name }
...
func (e *TrainingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TrainingEntity) Deleted() bool {
	return e.deleted
}


func (e *TrainingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTrainingEntity(e.client, opts)
}

func (e *TrainingEntity) Data(args ...any) any {
...
func (e *TrainingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Training; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TrainingEntity) DataTyped(data ...Training) Training {
	if len(data) > 0 {
		return typedFrom[Training](e.Data(asMap(data[0])))
	}
	return typedFrom[Training](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Training (all fields
// optional at the wire level).
func (e *TrainingEntity) MatchTyped(match ...Training) Training {
	if len(match) > 0 {
		return typedFrom[Training](e.Match(asMap(match[0])))
	}
	return typedFrom[Training](e.Match())
}
...
func (e *TrainingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TrainingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TrainingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TrainingListMatch and returns []Training. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TrainingEntity) ListTyped(reqmatch TrainingListMatch, ctrl map[string]any) ([]Training, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Training](res), nil
}




func (e *TrainingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// TrainingCreateData and returns an Training. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TrainingEntity) CreateTyped(reqdata TrainingCreateData, ctrl map[string]any) (Training, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Training{}, err
	}
	return typedFrom[Training](res), nil
}



func (e *TrainingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TrainingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TrainingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
