...
func NewInteractionEntity(client *core.AiCatsSDK, entopts map[string]any) *InteractionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InteractionEntity) GetName() string { return e.name }
...
func (e *InteractionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InteractionEntity) Deleted() bool {
	return e.deleted
}


func (e *InteractionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInteractionEntity(e.client, opts)
}

func (e *InteractionEntity) Data(args ...any) any {
...
func (e *InteractionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *InteractionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InteractionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *InteractionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *InteractionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InteractionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InteractionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
