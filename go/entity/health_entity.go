...
func NewHealthEntity(client *core.AiCatsSDK, entopts map[string]any) *HealthEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HealthEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// HealthCreateData and returns an Health. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *HealthEntity) CreateTyped(reqdata HealthCreateData, ctrl map[string]any) (Health, error) {
