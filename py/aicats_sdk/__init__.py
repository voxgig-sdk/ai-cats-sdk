...
from aicats_sdk.utility import register

# Load features
from aicats_sdk.feature.base_feature import AiCatsBaseFeature
from aicats_sdk.features import _has_feature, _make_feature
...
class AiCatsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AiCatsUtility()
        self._utility = utility

        from aicats_sdk.config import shared_config
    ...
    def get_utility(self):
        return AiCatsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AiCatsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Cat(self, data=None) -> "CatEntity":
        ...
        from aicats_sdk.entity.cat_entity import CatEntity
    ...
    def CatImage(self, data=None) -> "CatImageEntity":
        ...
        from aicats_sdk.entity.cat_image_entity import CatImageEntity
    ...
    def Health(self, data=None) -> "HealthEntity":
        ...
        from aicats_sdk.entity.health_entity import HealthEntity
    ...
    def Interaction(self, data=None) -> "InteractionEntity":
        ...
        from aicats_sdk.entity.interaction_entity import InteractionEntity
    ...
    def Training(self, data=None) -> "TrainingEntity":
        ...
        from aicats_sdk.entity.training_entity import TrainingEntity
