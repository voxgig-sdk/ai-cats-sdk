...
from aicats_sdk.core.helpers import get_ctx_prop, to_map
...
class AiCatsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, AiCatsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AiCatsError(code, msg, self)
