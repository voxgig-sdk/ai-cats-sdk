# AiCats SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AiCatsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AiCatsSDK(...) and AiCatsSDK.test(...) become
#      AiCatsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "aicats_sdk"
_SDK_CLASS = "AiCatsSDK"
