...
class AiCatsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AiCatsTestRunner.getenv("AI_CATS_TEST_LIVE")
        override = AiCatsTestRunner.getenv("AI_CATS_TEST_OVERRIDE")
        ...
        explain = AiCatsTestRunner.getenv("AI_CATS_TEST_EXPLAIN")
