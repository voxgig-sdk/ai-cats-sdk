...
AiCatsSDK._make_feature = _make_feature


function AiCatsSDK.new(options)
  local self = setmetatable({}, AiCatsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function AiCatsSDK:options_map()
...
function AiCatsSDK:get_utility()
  return Utility.copy(self._utility)
end


function AiCatsSDK:get_root_ctx()
  return self._rootctx
end


function AiCatsSDK:prepare(fetchargs)
...
function AiCatsSDK:direct(fetchargs)
...
-- by passing it.
function AiCatsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function AiCatsSDK:graphql(query, variables, ctrl)
...
function AiCatsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = AiCatsSDK.new(sdkopts)
  sdk.mode = "test"
