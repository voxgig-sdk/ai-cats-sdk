...
describe("CatImageDirect", function()
  it("should direct-load-cat_image", function()
    local setup = cat_image_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cat_image", setup.live and "live" or "unit")
...
function cat_image_direct_setup(mockres)
