...
describe("InteractionDirect", function()
  it("should direct-list-interaction", function()
    local setup = interaction_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-interaction", setup.live and "live" or "unit")
...
function interaction_direct_setup(mockres)
