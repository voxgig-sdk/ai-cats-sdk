...
describe("TrainingDirect", function()
  it("should direct-list-training", function()
    local setup = training_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-training", setup.live and "live" or "unit")
...
function training_direct_setup(mockres)
